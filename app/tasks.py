...
def _sessions_next_hour():
    """Sessions that start within the next hour (Africa/Johannesburg local)."""
...
def register_tasks(app):
    ...
    def admin_notify():
        ...
        - At ~04:00 UTC→SA local morning pass: show full-day.
        ...
        try:
            ...
            # Use DB now() just to get hour; localization is handled inside SQL blocks above.
            with get_session() as s:
            ...
            # Plain text send (keep simple and reliable)
        ...
        try:
            ...
            with get_session() as s:
                for sess in rows:
                    ...
                    # Use template if desired (approved), else plain text:
                    # for a in attendees:

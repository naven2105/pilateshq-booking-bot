...
from .admin_nudge import handle_admin_reply   # ✅ all Nadine replies routed here
...
def webhook():
    ...
    if from_wa == normalize_wa(NADINE_WA):
        # ✅ always send Nadine’s replies through admin_nudge

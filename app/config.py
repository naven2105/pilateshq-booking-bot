...
# ── Templates ────────────────────────────────────────────────────────────────
# Always default to en_US since that’s what Meta approved for your templates
ADMIN_TEMPLATE_NAME = os.environ.get("ADMIN_TEMPLATE_NAME", "admin_update_us")
ADMIN_TEMPLATE_LANG = os.environ.get("ADMIN_TEMPLATE_LANG", "en_US")

CLIENT_TEMPLATE_TOMORROW       = os.environ.get("CLIENT_TEMPLATE_TOMORROW", "client_session_tomorrow_us")
CLIENT_TEMPLATE_TOMORROW_LANG  = os.environ.get("CLIENT_TEMPLATE_TOMORROW_LANG", "en_US")

CLIENT_TEMPLATE_NEXT_HOUR      = os.environ.get("CLIENT_TEMPLATE_NEXT_HOUR", "client_session_next_hour_us")
CLIENT_TEMPLATE_NEXT_HOUR_LANG = os.environ.get("CLIENT_TEMPLATE_NEXT_HOUR_LANG", "en_US")

CLIENT_TEMPLATE_WEEKLY         = os.environ.get("CLIENT_TEMPLATE_WEEKLY", "client_weekly_schedule_us")
CLIENT_TEMPLATE_WEEKLY_LANG    = os.environ.get("CLIENT_TEMPLATE_WEEKLY_LANG", "en_US")

# ── Flags ────────────────────────────────────────────────────────────────────
USE_TEMPLATES = os.environ.get("USE_TEMPLATES", "1") in ("1", "true", "True")
TEMPLATE_LANG = os.environ.get("TEMPLATE_LANG", "en_US")
